...
import { FramerateReducer } from '../framerate-reducer';
...
interface Connection_ {
  ...
  setVoiceBitRate: (...args: any[]) => any;
  setCameraBitRate: (...args: any[]) => any;
  ...
  setDesktopSource: (source: string, options: DesktopSourceOptions) => void;
...
export interface DesktopSourceOptions extends Resolution {
  fps: number;
